...
import com.ecommerce.webapp.service.impl.JWTServiceImpl;
...
public class JWTRequestFilter extends OncePerRequestFilter implements ChannelInterceptor {
    ...
    public JWTRequestFilter(JWTServiceImpl jwtServiceImpl, LocalUserDAO localUserDAO) {
    ...
    private UsernamePasswordAuthenticationToken checkToken(String token, String providerName) {
        if (token != null && token.startsWith(BEARER_)) {
            ...
            try {
                String username = jwtServiceImpl.getUsername(token, providerName);
